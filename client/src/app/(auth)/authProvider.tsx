...
Amplify.configure(
  ...
  // By Default AWS Cognito foloseste Local Storage, cu aceasta optiune folosim cookies
  // {
  //   ssr: true,
  // },
);
      ...
      return (
        <View className="mt-4 text-center">
          <p className="text-muted-foreground">
            ...
            <button
              onClick={toSignIn}
              className="text-primary cursor-pointer border-none bg-transparent p-0 hover:underline"
            >
              Sign in
            </button>
          </p>
