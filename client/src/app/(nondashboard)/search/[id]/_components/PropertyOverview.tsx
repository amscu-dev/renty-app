  ...
  if (isLoading)
    return (
      <div className="w-full">
        <Skeleton className="mb-[17px] h-[20px] w-[160px] bg-slate-300 shadow-xl" />
        <Skeleton className="mb-[17px] h-[31px] w-[320px] bg-slate-300 shadow-xl" />
        <div className="flex w-full items-center justify-between gap-24">
          <Skeleton className="mb-[17px] h-[17px] w-3/4 bg-slate-300 shadow-xl" />
          <Skeleton className="mb-[17px] h-[17px] w-1/4 bg-slate-300 shadow-xl" />
        </div>
        <Skeleton className="mb-[56px] h-[70px] w-full bg-slate-300 shadow-xl" />
        <Skeleton className="mb-[17px] h-[21px] w-[320px] bg-slate-300 shadow-xl" />
        <Skeleton className="mb-[56px] h-[340px] w-full bg-slate-300 shadow-xl" />
      </div>
    );
  if (isError || !property) {
    return (
      <NoData message="This property does not exists. Please search another one." />
    );
  }
