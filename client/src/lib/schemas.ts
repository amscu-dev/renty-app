...
export const propertySchema = z.object({
  ...
  description: z
    .string()
    .min(25, "A description of minimum 25 characters is required.")
    .max(250, "A description can have maximum 250 characters."),
  ...
  amenities: z.array(z.enum(AmenityEnum)).min(1, "Select at least one amenity"),
  highlights: z
  ...
  housenumber: z.string().min(1, "Address number is required."),
