  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:outline-[4px] focus-visible:outline-offset-[5px] focus-visible:outline-amber-600",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-150",
        className,
      )}
      {...props}
    />
